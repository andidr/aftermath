...
#ifndef AM_TELAMONCANDIDATETREEWIDGETCREATOR_H
#define AM_TELAMONCANDIDATETREEWIDGETCREATOR_H
 ...
 *
 */
class TelamonCandidateTreeWidgetCreator : public NonContainerWidgetCreator {
	public:
		TelamonCandidateTreeWidgetCreator();
