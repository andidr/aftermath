...
#ifndef AM_DFG_NODE_COUNT_H
#define AM_DFG_NODE_COUNT_H
...
AM_DFG_DECL_BUILTIN_NODE_TYPE(
	am_dfg_count_node_type,
	"am::core::count",
	"Count",
	AM_DFG_NODE_DEFAULT_SIZE,
	AM_DFG_DEFAULT_PORT_DEPS_PURE_FUNCTIONAL,
	AM_DFG_NODE_FUNCTIONS({
		.process = am_dfg_count_node_process
	}),
	AM_DFG_NODE_PORTS(
		{ "in", "am::core::any", AM_DFG_PORT_IN },
		{ "count", "am::core::uint64", AM_DFG_PORT_OUT }),
	AM_DFG_PORT_DEPS(),
	AM_DFG_NODE_PROPERTIES())

AM_DFG_ADD_BUILTIN_NODE_TYPES(&am_dfg_count_node_type)
