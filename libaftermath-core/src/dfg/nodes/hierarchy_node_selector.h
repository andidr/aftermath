...
#ifndef AM_DFG_NODE_HIERARCHY_NODE_SELECTOR_H
#define AM_DFG_NODE_HIERARCHY_NODE_SELECTOR_H

#include <aftermath/core/dfg_node.h>

struct am_dfg_hierarchy_node_selector_node {
...
/* Node selecting hierarchy nodes from a set of hierarchies whose name matches a
 * name provided as a property */
AM_DFG_DECL_BUILTIN_NODE_TYPE(
	am_dfg_hierarchy_node_selector_node_type,
	"am::core::hierarchy_node_selector",
	"Hierarchy Node Selector",
	sizeof(struct am_dfg_hierarchy_node_selector_node),
	AM_DFG_DEFAULT_PORT_DEPS_PURE_FUNCTIONAL,
	AM_DFG_NODE_FUNCTIONS({
		.init = am_dfg_hierarchy_node_selector_node_init,
		.destroy = am_dfg_hierarchy_node_selector_node_destroy,
		.process = am_dfg_hierarchy_node_selector_node_process,
		.set_property = am_dfg_hierarchy_node_selector_node_set_property,
		.get_property = am_dfg_hierarchy_node_selector_node_get_property,
		.from_object_notation =
			am_dfg_hierarchy_node_selector_node_from_object_notation,
		.to_object_notation =
...
AM_DFG_ADD_BUILTIN_NODE_TYPES(&am_dfg_hierarchy_node_selector_node_type)
