...
int event_set_get_state_durations(struct event_set* es, struct filter* f, uint64_t start, uint64_t end, int num_states, uint64_t* state_durations, int init, int break_half);
