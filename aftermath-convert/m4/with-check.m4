...
# the required linker flags is defined and substituted (where XXX is
...
# a variable XXX_INCLUDES with the required compiler flags is defined
...
# (where XXX is the uppercase package name).
#
